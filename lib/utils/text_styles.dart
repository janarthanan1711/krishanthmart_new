...
class TextStyles {
  ...
  static TextStyle largeBoldAccentTexStyle() {
    return const TextStyle(fontSize: 16, color: MyTheme.accent_color,fontWeight: FontWeight.w700);
  }

  static TextStyle smallBoldAccentTexStyle() {
    return const TextStyle(fontSize: 13, color: MyTheme.accent_color,fontWeight: FontWeight.w700);
  }
