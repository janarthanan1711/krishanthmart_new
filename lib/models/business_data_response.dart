...
//     List<BusinessLogicResponseDatas>.from(json.decode(str).map((x) => BusinessLogicResponseDatas.fromJson(x)));
//
// // String businessLogicResponseDatasToJson(List<BusinessLogicResponseDatas> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
//
//
