...
class CartResponse {
  ...
  //   print("Getting Cart Response===========>${json}");
  //   return CartResponse(
  //     grandTotal: json[0]["grand_total"],
  //     data: json[0]["data"] == null
  //         ? []
  //         : List<Datum>.from(json[0]["data"].map((x) => Datum.fromJson(x as Map<String, dynamic>))),
  //   );
  // }
  factory CartResponse.fromJson(List<dynamic> json) {
    print("Getting Cart Response===========>${json}");
    print("Getting Cart Response===========>${json[0]['grand_total']}");
    return CartResponse(
      grandTotal: json[0]["grand_total"],
      data: json[0]["data"] == null
          ? []
