...
class Products {
  ...
  List<ProductFlash>? products;

  factory Products.fromJson(Map<String, dynamic> json) => Products(
    products: List<ProductFlash>.from(json["data"].map((x) => ProductFlash.fromJson(x))),
  );
...
class ProductFlash {
  ...
  factory ProductFlash.fromJson(Map<String, dynamic> json) => ProductFlash(
    id: json["id"],
    name: json["name"],
    price: json["price"],
    image: json["image"],
