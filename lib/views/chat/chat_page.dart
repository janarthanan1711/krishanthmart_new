    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.only(
          ...
          bottomLeft:
          _list[index].sendType=="customer" ? const Radius.circular(16) : const Radius.circular(0),
          bottomRight:
          _list[index].sendType=="customer" ? const Radius.circular(0) : const Radius.circular(16),
        ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.only(
            ...
            topRight: const Radius.circular(16),
            bottomLeft:
            index.isOdd? const Radius.circular(16) : const Radius.circular(0),
            bottomRight:
            index.isOdd? const Radius.circular(0) : const Radius.circular(16),
          ),
          color: (index.isOdd
              ? MyTheme.accent_color
              : MyTheme.accent_color),
