...
import '../../utils/quantity_input_fields.dart';
...
import '../product_reviews/product_review_page.dart';
import '../videodescription/video_description.dart';
import '../webview/common_webview_screen.dart';
import 'components/mini_product_card.dart';
...
class _ProductDetailsState extends State<ProductDetails>
  ...
  void initState() {
    ...
    // productController.getVariantData(widget.id);
    fetchAll();
    super.initState();
  }
        ...
        children: [
          ...
          Visibility(
            ...
            child: Padding(
              ...
              child: Text(
                  convertPrice(mrpPrice.toString()),
                  style:  TextStyle(
  ...
  Widget buildWholeSaleQuantityPrice() {
    return DataTable(
      ...
      columns: [
        DataColumn(
            label: Text(AppLocalizations.of(context)!.min_qty_ucf,
                style: TextStyle(fontSize: 12, color: MyTheme.dark_grey))),
        DataColumn(
            label: Text(AppLocalizations.of(context)!.max_qty_ucf,
                style: TextStyle(fontSize: 12, color: MyTheme.dark_grey))),
        DataColumn(
            label: Text(AppLocalizations.of(context)!.unit_price_ucf,
                style: TextStyle(fontSize: 12, color: MyTheme.dark_grey))),
      ],
  ...
  Widget buildClubPointRow() {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          color:
              //Colors.red,),
              const Color.fromRGBO(253, 235, 212, 1)),
      child: Padding(
            ...
            Row(
              children: [
                ...
                Text(
                  ...
                  style:
                      const TextStyle(color: MyTheme.font_grey, fontSize: 10),
                ),
              ],
            ),
            Text(
